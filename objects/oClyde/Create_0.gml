...
/// ===============================================================================
/// Purpose: Initialize CLYDE (Orange Ghost) with oGhost inheritance
/// Personality: 
/// Strategy: 
/// Scatter Corner: 
///
/// This event runs when Pinky instance is created at room start.
...
ghost_name = "Clyde";                      // Ghost identifier string
ghost_color = ghost_color_clyde();         // Orange color
...
xstart = 248;                               // Spawn X coordinate (pixel)
...
cornerx = 416;                              // Scatter target X coordinate (bottom-right)
cornery = 432;                               // Scatter target Y coordinate (bottom-right)
...
state = GHOST_STATE.HOUSE_READY;				// Start in house
dir = GRID_DIRECTION.LEFT;						// Start facing right

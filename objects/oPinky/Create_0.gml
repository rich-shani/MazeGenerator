...
/// ===============================================================================
/// Purpose: Initialize Pinky (Pink Ghost) with oGhost inheritance
/// Personality: 
/// Strategy: 
/// Scatter Corner: 
///
...
ghost_name = "Pinky";                      // Ghost identifier string
ghost_color = ghost_color_pinky();         // Red color: RGB(255, 0, 0)
...
cornerx = 16;                              // Scatter target X coordinate (top-left)
cornery = 32;                               // Scatter target Y coordinate (top-left)
...
dir = GRID_DIRECTION.UP;						// Start facing right
